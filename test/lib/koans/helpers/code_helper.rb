module KoansHelper
  ...
  module Model
    def koan_message
      "Find the test file and failing test inside it and change the test code, so that the behavior we're specifying in our tests matches application behavior."
    end
